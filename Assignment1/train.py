...
from PyTorchTutorial.DeepLearningCourse.Assignment1.NetworkModelFFN import Feedforward
...
print((4040 * 128) + (128*128) + (128*128) + (128*128) + (128*3) + (128 + 128 + 128 + 128 + 3))
print('Defining the model...')
print('Input Size', no_tf*no_qb)
no_cl = 3 # No. of classes.
model = Feedforward(no_tf*no_qb,128,no_cl)
summary(model, (1,4040))
model.cuda()
...
ax.set_ylabel('Loss')
ax.legend()
plt.savefig("Plots/loss_elu.png")
plt.show()
